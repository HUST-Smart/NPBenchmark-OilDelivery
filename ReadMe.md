...
- **Checker/**
  中石油配送问题计算结果检查程序的 Visual C++ 项目.

- **Analyzer/**
  中石油配送问题算例/结果/日志分析程序的 Visual C# 项目.
...
3. 打开根目录下的 Visual Studio 2017 解决方案文件 `OilDelivery.sln`, 设置输出选项为 Release x64, 生成解决方案.
