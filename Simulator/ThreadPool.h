...
#ifndef LCG_CPPUTILIBS_THREAD_POOL_H
#define LCG_CPPUTILIBS_THREAD_POOL_H
...
public:
    ...
    virtual void pend() {
        setState(State::Pend);
        waitAll(); // OPTIMIZE[lcg][0]: detach and move on instead of waiting?
    }
...
// [ManualStart][ManualPend][ManualStop]
    ...
    public:
        ...
        virtual void push(Job &&newJob) override {
            ...
            workerCv.wait(workerLock, [this]() { return isSlotEmpty(); }); // OPTIMIZE[lcg][0]: assume spurious wake up will never happen?
...
public:
    ...
    // EXTEND[lcg][9]: provide std::future?
};

}


#endif // LCG_CPPUTILIBS_THREAD_POOL_H
