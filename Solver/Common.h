...
#ifndef SMART_LCG_OIL_DELIVERY_COMMON_H
#define SMART_LCG_OIL_DELIVERY_COMMON_H
...
using Iteration = int;
// total revenue of the delivery
using Revenue = double;
...
#endif // SMART_LCG_OIL_DELIVERY_COMMON_H
