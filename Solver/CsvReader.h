...
#ifndef SMART_LCG_OIL_DELIVERY_CSV_READER_H
#define SMART_LCG_OIL_DELIVERY_CSV_READER_H
...
#define SMART_LCG_OIL_DELIVERY_CSV_READER_RECURSIVE_VERSION  0
...
public:
    ...
    const std::vector<Row>& scan(std::ostringstream &oss) {
        ...
        #if SMART_LCG_OIL_DELIVERY_CSV_READER_RECURSIVE_VERSION
        onNewLine(begin);
        #else
        onNewLine_opt(begin);
        #endif // SMART_LCG_OIL_DELIVERY_CSV_READER_RECURSIVE_VERSION
...
//Label_OnValue:
    ...
    // TODO[lcg][2]: handle quote (comma will not end cell).
    // EXTEND[lcg][5]: make trim space configurable.
...
#endif // SMART_LCG_OIL_DELIVERY_CSV_READER_H
